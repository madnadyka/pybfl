import struct
import io
from pybfl.functions.tools import int_to_var_int, read_var_int, var_int_to_int
from  math import log, ceil, floor, log2
from pybfl.constants import LN2SQUARED, LN2
from pybfl.functions.tools import  map_into_range, get_stream
from pybfl.functions.hash import siphash, murmurhash3
