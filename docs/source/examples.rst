...
.. code-block:: bash
      ...
      >>> pybfl.Address(address_type="P2PKH").address
      '1ChpKurzFhdCULKaNHCc3Ra9KfxM2LRguw'
      >>>
      >>> # create testnet address
      >>> pybfl.Address(address_type="P2PKH", testnet=True).address
      'mpR4hDfu269yxgZtPVYSD21gtpvdxpTmH6'
      >>>
      >>> # create P2SH_P2WPKH SEGWIT adoption address
      >>> pybfl.Address(address_type="P2SH_P2WPKH").address
...
.. code-block:: bash
      ...
      >>> a = pybfl.Address('L5XKGA2xEHcinWEpmyiABS1bqQux8Av5dGVqcpRtVJC3ZCR5sXUe')
      >>> a.address
      'bc1q6cxx5t8xkruz3s5khx7923xvsx5ry4c6p74m5s'
      >>> a.public_key.hex
      ...
      >>> pub = pybfl.PublicKey('03b8b44876e1f45be7e42953ea47026c39cc45341344d3ab32701b93de696107af')
      >>>
      >>> pybfl.Address(pub).address
      'bc1q6cxx5t8xkruz3s5khx7923xvsx5ry4c6p74m5s'
      >>>
...
.. code-block:: bash
      ...
      >>> import pybfl
      >>> pybfl.create_private_key()
      'KyvZYvdzWD4JSPFt4wXwjG53as227zT2qiWbMTicZEUSjiwvbEqi'
      >>>
      >>> pybfl.create_private_key(compressed=False)
      '5Jw8DY1uBrd35xup6eD6KLEFa4AJFbX381HWuHvPGirJto9ZTnr'
      >>>
      >>> pybfl.is_wif_valid('5Jw8DY1uBrd35xup6eD6KLEFa4AJFbX381HWuHvPGirJto9ZTnr')
      True
      >>> pybfl.is_wif_valid('5Jw8DY1uBrd35xup6eD6KLEFa4AJFbX381**********Jto9ZTnr')
      False
      >>>
...
.. code-block:: bash
      ...
      >>> import pybfl
      >>> pybfl.private_to_public_key('5Jw8DY1uBrd35xup6eD6KLEFa4AJFbX381HWuHvPGirJto9ZTnr')
      ...
      >>>
      >>> pybfl.public_key_to_address('0479f17a94410afd4f27588a192bacada53add0741765092dc0f8e2a29ea1bcd276dbc1ef74c3e0172d9db8047f2a0a5dc2e8e51a13f7f0cc072de906b765e0f7f')
      >>>
      ...
      >>> pub = pybfl.private_to_public_key('5Jw8DY1uBrd35xup6eD6KLEFa4AJFbX381HWuHvPGirJto9ZTnr')
      >>> pybfl.public_key_to_address(pub, witness_version=None)
...
.. code-block:: bash
      ...
      >>> pybfl.is_address_valid('17mXwxxZRmj1nJJzDszZbW9URSAradEuAt')
      True
      >>> pybfl.address_type('17mXwxxZRmj1nJJzDszZbW9URSAradEuAt')
      'P2PKH'
      >>> pybfl.address_net_type('17mXwxxZRmj1nJJzDszZbW9URSAradEuAt')
      'mainnet'
      >>>
