...
setup(name='pybfl',
      version='2.2.0',
      description='Python Bitflate library',
      keywords='bitcoin',
      url='https://github.com/madnadyka/pybfl',
      author='Alexsei Karpov',
      author_email='admin@bitaps.com',
      license='GPL-3.0',
      # include_package_data=True,
      package_data={
          'pybfl': ['bip39_word_list/*.txt', 'test/*.txt'],
      },
      cmdclass={
      ...
      ext_modules=[Extension("cache_strategies", ["pybfl/cache_strategies/cache.c"]),
                   Extension("_bitarray", ["pybfl/bitarray/_bitarray.c"]),
                   Extension("_secp256k1", ["pybfl/_secp256k1/module_secp256k1.c"],
                             include_dirs=["libsecp256k1/include/", "libsecp256k1/src/"]),
                   Extension("_crypto",
                             ["pybfl/_crypto/module_crypto.cpp",
                              "pybfl/_crypto/crypto/aes.cpp",
                              "pybfl/_crypto/crypto/hmac_sha256.cpp",
                              "pybfl/_crypto/crypto/hmac_sha512.cpp",
                              "pybfl/_crypto/crypto/sha256.cpp",
                              "pybfl/_crypto/crypto/sha256_avx2.cpp",
                              "pybfl/_crypto/crypto/sha256_shani.cpp",
                              "pybfl/_crypto/crypto/sha256_sse4.cpp",
                              "pybfl/_crypto/crypto/sha256_sse41.cpp",
                              "pybfl/_crypto/crypto/sha512.cpp",
                              "pybfl/_crypto/crypto/compat/glibc_compat.cpp",
                              "pybfl/_crypto/crypto/compat/glibc_sanity.cpp",
                              "pybfl/_crypto/crypto/compat/glibcxx_sanity.cpp",
                              "pybfl/_crypto/crypto/compat/strnlen.cpp",
                              "pybfl/_crypto/crypto/base58.cpp",
                              "pybfl/_crypto/crypto/hash.cpp",
                              "pybfl/_crypto/crypto/uint256.cpp",
                              "pybfl/_crypto/crypto/utilstrencodings.cpp",
                              ],
                             extra_compile_args=['-std=c++11'],
                             include_dirs=["pybfl/_crypto/crypto"])
                   ],
